...
! function(e) {
    ...
    function a(t, i) {
        ...
        return "area" === u ? (n = (s = t.parentNode).name, !(!t.href || !n || "map" !== s.nodeName.toLowerCase()) && (!!(a = e("img[usemap='#" + n + "']")[0]) && o(a))) : (/^(input|select|textarea|button|object)$/.test(u) ? !t.disabled : "a" === u && t.href || i) && o(t)
    }
    ...
    var e = $(window).width(),
        ...
        i = function() {
            ...
            if (jQuery(".dzload").each(function() {
                ...
                if (0 == $(".mo-left .header-nav").children(".logo-header").length) {
            ...
            $(".header-nav li").unbind().each(function(e) {
                if ($("ul", this).length) {
                    var t = $("ul:first", this),
                        ...
                        r = t.width();
                    $("body").height();
                    i + r <= $("body").width() ? $(this).find(".sub-menu:first").removeClass("left") : $(this).find(".sub-menu:first").addClass("left")
                }
            })
        },
        u = function() {
        ...
        c = new Date;
    return c.setMonth(c.getMonth() + 1), c = c.getDate() + " " + ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"][c.getMonth()] + " " + c.getFullYear(), {
        init: function() {
            jQuery(".box-hover").on("mouseenter", function() {
                ...
                }(), s(), jQuery('iframe[src*="youtube.com"]').wrap('<div class="embed-responsive embed-responsive-16by9"></div>'), jQuery('iframe[src*="vimeo.com"]').wrap('<div class="embed-responsive embed-responsive-16by9"></div>'), jQuery("#image-gallery-mix").length && (jQuery(".gallery-filter").find("li").each(function() {
                ...
                }(c), $(".content-scroll").length && $(".content-scroll").mCustomScrollbar({
                    setWidth: !1,
                    setHeight: !1,
                    axis: "y"
                ...
                }), $(".full-height").css("height", $(window).height()), r(), jQuery(window).on("resize", function() {
                    jQuery(".modal:visible").each(u), jQuery(".equal-wraper").length && n(".equal-wraper .equal-col"), a()
        ...
        load: function() {
            e > 1023 && jQuery(".bgeffect").length && skrollr.init({
                ...
                }), n(".equal-wraper .equal-col"), n(".equal-wraper2 .equal-col"), n(".equal-wraper3 .equal-col"), jQuery(".counter").length && jQuery(".counter").counterUp({
                    delay: 10,
                    time: 3e3
                }), l(),
                function() {
                ...
                }(), jQuery("body").append('<a href="#" target="_blank" class="bt-support-now theme-btn"><i class="fa fa-whatsapp"></i><span>Whatsapp</span></a>\x3c!-- Go to www.addthis.com/dashboard to customize your tools --\x3e<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5b221c5e31b4e54b"><\/script>')
        },
        resize: function() {
            e = $(window).width(), i(), t(), o(), l(), s(), r()
        }
    }
}();
jQuery(document).ready(function() {
    "use strict";
    Agency.init(), $(".dez-page").on("click", function() {
        "#" == $(this).attr("href") && "" == $(this).attr("href") || jQuery("#loading-area").find("div").addClass("la-animate")
...
jQuery(window).on("load", function() {
    ...
    addSwitcher(), jQuery(".switch-btn").on("click", function() {
        ...
        return jQuery(".skin").attr("href", "css/skin/color/skin-1.css"), jQuery(".logo-header img").attr("src", "images/logo.png"), jQuery(".header-ind .logo-header img").attr("src", "images/logo-color-1.png"), jQuery(".header-seo .logo-header img").attr("src", "images/logo-color-1.png"), !1
    }), jQuery(".color-skins-db .skin-1").on("click", function() {
        return jQuery(".skin").attr("href", "css/skin/skin-1.css"), jQuery(".logo-header img").attr("src", "images/logo1.png"), jQuery(".header-ind .logo-header img").attr("src", "images/logo-color-1.png"), jQuery(".header-seo .logo-header img").attr("src", "images/logo-color-1.png"), !1
    }), jQuery(".skin-2").on("click", function() {
        return jQuery(".skin").attr("href", "css/skin/color/skin-2.css"), jQuery(".logo-header img").attr("src", "images/logo2.png"), jQuery(".header-ind .logo-header img").attr("src", "images/logo-color-2.png"), jQuery(".header-seo .logo-header img").attr("src", "images/logo-color-2.png"), !1
    }), jQuery(".color-skins-db .skin-2").on("click", function() {
        return jQuery(".skin").attr("href", "css/skin/skin-2.css"), jQuery(".logo-header img").attr("src", "images/logo2.png"), jQuery(".header-ind .logo-header img").attr("src", "images/logo-color-2.png"), jQuery(".header-seo .logo-header img").attr("src", "images/logo-color-2.png"), !1
    }), jQuery(".skin-3").on("click", function() {
        return jQuery(".skin").attr("href", "css/skin/color/skin-3.css"), jQuery(".logo-header img").attr("src", "images/logo3.png"), jQuery(".header-ind .logo-header img").attr("src", "images/logo-color-3.png"), jQuery(".header-seo .logo-header img").attr("src", "images/logo-color-3.png"), !1
    }), jQuery(".color-skins-db .skin-3").on("click", function() {
        return jQuery(".skin").attr("href", "css/skin/skin-3.css"), jQuery(".logo-header img").attr("src", "images/logo3.png"), jQuery(".header-ind .logo-header img").attr("src", "images/logo-color-3.png"), jQuery(".header-seo .logo-header img").attr("src", "images/logo-color-3.png"), !1
    }), jQuery(".skin-4").on("click", function() {
        return jQuery(".skin").attr("href", "css/skin/color/skin-4.css"), jQuery(".logo-header img").attr("src", "images/logo4.png"), jQuery(".header-ind .logo-header img").attr("src", "images/logo-color-4.png"), jQuery(".header-seo .logo-header img").attr("src", "images/logo-color-4.png"), !1
    }), jQuery(".color-skins-db .skin-4").on("click", function() {
        return jQuery(".skin").attr("href", "css/skin/skin-4.css"), jQuery(".logo-header img").attr("src", "images/logo4.png"), jQuery(".header-ind .logo-header img").attr("src", "images/logo-color-4.png"), jQuery(".header-seo .logo-header img").attr("src", "images/logo-color-4.png"), !1
    }), jQuery(".skin-5").on("click", function() {
        return jQuery(".skin").attr("href", "css/skin/color/skin-5.css"), jQuery(".logo-header img").attr("src", "images/logo5.png"), jQuery(".header-ind .logo-header img").attr("src", "images/logo-color-5.png"), jQuery(".header-seo .logo-header img").attr("src", "images/logo-color-5.png"), !1
    }), jQuery(".color-skins-db .skin-5").on("click", function() {
        return jQuery(".skin").attr("href", "css/skin/skin-5.css"), jQuery(".logo-header img").attr("src", "images/logo5.png"), jQuery(".header-ind .logo-header img").attr("src", "images/logo-color-5.png"), jQuery(".header-seo .logo-header img").attr("src", "images/logo-color-5.png"), !1
    }), jQuery(".skin-6").on("click", function() {
        return jQuery(".skin").attr("href", "css/skin/color/skin-6.css"), jQuery(".logo-header img").attr("src", "images/logo6.png"), jQuery(".header-ind .logo-header img").attr("src", "images/logo-color-6.png"), jQuery(".header-seo .logo-header img").attr("src", "images/logo-color-6.png"), !1
    }), jQuery(".color-skins-db .skin-6").on("click", function() {
        return jQuery(".skin").attr("href", "css/skin/skin-6.css"), jQuery(".logo-header img").attr("src", "images/logo6.png"), jQuery(".header-ind .logo-header img").attr("src", "images/logo-color-6.png"), jQuery(".header-seo .logo-header img").attr("src", "images/logo-color-6.png"), !1
    }), jQuery(".skin-7").on("click", function() {
        return jQuery(".skin").attr("href", "css/skin/color/skin-7.css"), jQuery(".logo-header img").attr("src", "images/logo7.png"), jQuery(".header-ind .logo-header img").attr("src", "images/logo-color-7.png"), jQuery(".header-seo .logo-header img").attr("src", "images/logo-color-7.png"), !1
    }), jQuery(".color-skins-db .skin-7").on("click", function() {
        return jQuery(".skin").attr("href", "css/skin/skin-7.css"), jQuery(".logo-header img").attr("src", "images/logo7.png"), jQuery(".header-ind .logo-header img").attr("src", "images/logo-color-7.png"), jQuery(".header-seo .logo-header img").attr("src", "images/logo-color-7.png"), !1
    }), jQuery(".skin-8").on("click", function() {
        return jQuery(".skin").attr("href", "css/skin/color/skin-8.css"), jQuery(".logo-header img").attr("src", "images/logo8.png"), jQuery(".header-ind .logo-header img").attr("src", "images/logo-color-8.png"), jQuery(".header-seo .logo-header img").attr("src", "images/logo-color-8.png"), !1
    }), jQuery(".color-skins-db .skin-8").on("click", function() {
        return jQuery(".skin").attr("href", "css/skin/skin-8.css"), jQuery(".logo-header img").attr("src", "images/logo8.png"), jQuery(".header-ind .logo-header img").attr("src", "images/logo-color-8.png"), jQuery(".header-seo .logo-header img").attr("src", "images/logo-color-8.png"), !1
        ...
        jQuery("body").addClass("frame"), jQuery("body").removeClass("wide-layout"), jQuery("body").removeClass("boxed"), jQuery("body").removeClass("boxed"), jQuery("#ThemeRangeSlider").show("slow"), jQuery(".main-bar-wraper").addClass("sticky-no"), jQuery(".main-bar-wraper").removeClass("sticky-header")
    }), themeFramePadding(), jQuery(".nav-view li ").on("click", function() {
...
function themeFramePadding() {
    ...
    "" == e && (e = 20), $("#slider-range-3").unbind().slider({
        min: 20,
        max: 80,
        value: e,
        animate: "slow",
        orientation: "horizontal",
        slide: function(e, i) {
            frameSlider = i.value, $("#" + this.id).prev().val(frameSlider + "px"), $("#bg").css("padding", frameSlider + "px"), setCookie("frame_value", frameSlider, 1)
        }
    })
}
...
function setThemePanel() {
    jQuery.each(themeOption, function(e, i) {
        themeOptionItemValue = getCookie(i + "_value"), "" != themeOptionItemValue && ("themeStandardColor" == i ? (jQuery(".skin").attr("href", themeOptionItemValue + ".css"), setThemeLogo(i)) : "themeFullColor" == i ? (jQuery(".skin").attr("href", themeOptionItemValue + ".css"), setThemeLogo(i)) : "layout" == i ? (jQuery("." + i + "-view li").removeClass("active"), jQuery("." + i + "-view").find("." + themeOptionItemValue).addClass("active"), "frame" == themeOptionItemValue ? (jQuery("#ThemeRangeSlider").show("slow"), jQuery("body").addClass(themeOptionItemValue), themeOptionFrameValue = getCookie("frame_value"), "" == themeOptionFrameValue && (themeOptionFrameValue = 20), jQuery("#FramePadding").val(themeOptionFrameValue + "px"), jQuery("#bg").css("padding", themeOptionFrameValue + "px")) : jQuery("body").addClass(themeOptionItemValue)) : "header" == i ? (jQuery("." + i + "-view li").removeClass("active"), "sticky-header" == themeOptionItemValue ? jQuery("." + i + "-view").find(".header-fixed").addClass("active") : "sticky-no" == themeOptionItemValue && jQuery("." + i + "-view").find(".header-static").addClass("active"), jQuery(".main-bar-wraper").addClass(themeOptionItemValue)) : "bgColor" == i ? (jQuery("#bg").css("background-color", themeOptionItemValue), jQuery("#bg").css("background-image", "")) : "bgImage" == i ? jQuery("#bg").css({
...
function setThemeLogo(e) {
    ...
    "" != i && jQuery(".logo-header img").attr("src", i)
}

function setCookie(e, i, r) {
    var s = new Date;
    s.setTime(s.getTime() + 18e5);
    var a = "expires=" + s.toString();
    document.cookie = e + "=" + i + ";" + a + ";path=/"
}

function getCookie(e) {
    for (var i = e + "=", r = decodeURIComponent(document.cookie).split(";"), s = 0; s < r.length; s++) {
        for (var a = r[s];
...
themeOption.layout = ["wide", "boxed", "frame", "frame_value", "layout_value"], themeOption.themeStandardColor = ["skin-1", "skin-2", "skin-3", "skin-4", "skin-5", "skin-6", "skin-7", "skin-8", "themeStandardColor_value", "themeStandardColor_logo"], themeOption.themeFullColor = ["skin-1", "skin-2", "skin-3", "skin-4", "skin-5", "skin-6", "skin-7", "skin-8", "themeFullColor_value", "themeFullColor_logo"], themeOption.header = ["fixed", "static", "header_value"], themeOption.bgColor = ["#309da1", "#ff0096", "#002eff", "#00ccd3", "#ff2f00", "#490bb8", "#007df1", "#ff0101", "bgColor_value"], themeOption.bgImage = ["bg1.jpg", "bg2.jpg", "bg3.jpg", "bg4.jpg", "bgImage_value"], themeOption.bgPatten = ["pt1.jpg", "pt2.jpg", "pt3.jpg", "pt4.jpg", "pt5.jpg", "pt6.jpg", "pt7.jpg", "pt8.jpg", "pt9.jpg", "pt10.jpg", "pt11.jpg", "pt12.jpg", "bgPatten_value"], jQuery(document).ready(function() {
    jQuery(".theme-panel-save li a, .theme-panel-save li img").on("click", function() {
        var e = jQuery(this).attr("dir"),
            i = jQuery(this).parent().parent().attr("val");
        if ("bgColor" == i) deleteCookie("bgImage_value"), deleteCookie("bgPatten_value");
        else if ("bgImage" == i) deleteCookie("bgColor_value"), deleteCookie("bgPatten_value");
        else if ("bgPatten" == i) deleteCookie("bgColor_value"), deleteCookie("bgImage_value");
        else if ("themeStandardColor" == i) deleteCookie("themeFullColor_value");
        else if ("themeFullColor" == i) deleteCookie("themeStandardColor_value");
