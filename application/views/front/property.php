<?php include_once 'cmn_head.php';?>
    ...
    <div class="page-content bg-white">
        <!-- inner page banner -->
        <div class="dlab-bnr-inr overlay-primary" style="background-image:url(images/banner/bnr5.jpg);">
            <div class="container">
                <div class="dlab-bnr-inr-entry">
                    <h1 class="text-white">Property Agreements</h1>
					<!-- Breadcrumb row -->
		...
		<div class="content-block">
					...
					<div class="row">
						<div class="col-lg-8 col-md-7">
							<div class="section-head text-black">
								<h4 class="box-title m-tb0">Drafting Rent/Sale Agreements<span class="bg-primary"></span></h4>
								<p>Create your own lease / sale / rental agreement for your home property within minutes.Fill up the Agreement details online and we will mail you the soft copy of the agreement for review.</p>
								<p>We will procure required stamp paper and get the agreement printed.We will courier the agreement to your address for signing it.</p>
							</div>
							<div class="section-head text-black">
								<h4 class="box-title m-tb0">Notarizing and signing of Rent / Sale Agreements<span class="bg-primary"></span></h4>
								<p>Create your own lease / sale / rental agreement for your home property within minutes. Fill up the Agreement details online and we will mail you the soft copy of the agreement for review.</p>
								<p>We will procure required stamp paper and get the agreement printed.We will coordinate between respective parties for signing and then notarizing the agreement .</p>
							</div>
							<div class="section-head text-black">
								<h4 class="box-title m-tb0">Registration of Rental Agreement<span class="bg-primary"></span></h4>
								<p>Create your own lease / rental agreement for your home property within minutes.Fill up the Rental Agreement details online and we will mail you the soft copy of the agreement for review.We will procure required stamp paper and get the agreement printed. (Stamp duty extra)</p>
								<p>We will coordinate between owner and tenant for signing the agreement .Once signed, our executive will guide your throughout the process of registration at the registrar office to have a hassle free experience. ( court charges extra).Registration of agreements generally takes couple of days. So we will receive it from the registrar office and courier it to you</p>
							</div>
							<div class="section-head text-black">
								<h4 class="box-title m-tb0">Registration of Sale Deed<span class="bg-primary"></span></h4>
								<p>Our executive will get in touch for collecting all the required details.We will draft the sale deed and send the soft copy for review.We will procure required stamp paper and get the sale deed printed. (Stamp duty extra)</p>
                                <p>We will coordinate between respective parties for signing the sale deed.Once signed, our executive will guide your throughout the process of registration at the registrar office to have a hassle free experience. ( court charges extra),Registration of agreements generally takes couple of days. So we will receive it from the registrar office and courier it to you</p>
							</div>
						</div>
            ...
            <!-- Our Services -->
			<!-- Why Chose Us -->
			<div class="section-full content-inner-1 overlay-primary hide about-service bg-img-fix" style="background-image:url(images/background/bg1.jpg);">
				<div class="container">
			...
			<!-- Why Chose Us End -->
			<!-- Testimonials -->
			<div class="section-full content-inner hide wow fadeIn" data-wow-delay="0.4s" style="background-image:url(images/background/bg-map.jpg); background-position:center; background-repeat:no-repeat;">
                <div class="container">
					<div class="section-head text-center">
						<h2 class="box-title m-tb0">Our Testimonials<span class="bg-primary"></span></h2>
						<p> Get in touch with us, we will revert back to you soon. </p>
					</div>
						...
						<div class="testimonial-box item-center owl-loaded owl-theme owl-carousel owl-none mfp-gallery owl-dots-black-full">
							<div class="item">
								<div class="testimonial-8">
									<div class="testimonial-text">
										<p>Get in touch with us, we will revert back to you soon. when an printer took a galley of type and scrambled it to make [...]</p>
									</div>
									<div class="testimonial-detail clearfix">
										<div class="testimonial-pic radius shadow">
											<img src="images\testimonials\pic2.jpg" width="100" height="100" alt="">
										</div>
							...
							<div class="item">
								<div class="testimonial-8">
									...
									<div class="testimonial-detail clearfix">
										<div class="testimonial-pic radius shadow">
											<img src="images\testimonials\pic1.jpg" width="100" height="100" alt="">
										</div>
										<h5 class="testimonial-name m-t0 m-b5">Mr. Jone Deo</h5> 
										<span>Client</span> 
									</div>
							...
							<div class="item">
								<div class="testimonial-8">
									...
									<div class="testimonial-detail clearfix">
										<div class="testimonial-pic radius shadow">
											<img src="images\testimonials\pic3.jpg" width="100" height="100" alt="">
										</div>
										<h5 class="testimonial-name m-t0 m-b5">Mr. Jone Deo</h5> 
										<span>Client</span> 
									</div>
			...
			<!-- Testimonials END -->
			<!-- Get in touch -->
			<div class="section-full overlay-primary-dark hide bg-img-fix" style="background-image:url(images/background/bg1.jpg);">
				<div class="container">
					<div class="row">
