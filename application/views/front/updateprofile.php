	...
	<div class="dlab-bnr-inr  contact-page" >
		<div class="container">
			<div class="row justify-content-center">
                <div data-v-6eac0c7d="" class="referal-content-wrap"><div data-v-57b574e2="" data-v-6eac0c7d="" id="referral-form-card" class="bg-white pt-5 pb-5"><div data-v-57b574e2="" class="referral-form">
                <h5 data-v-57b574e2="" class="secondary-text-color mb-4 text-center">Update Profile</h5> 
                <div data-v-57fbc572="" data-v-57b574e2="" class="form-input">
                <input data-v-57fbc572="" type="text" pattern=".*" id="input-Name" class=""> 
                <label data-v-57fbc572="" for="input-Name" class="m-0">Name</label>
                </div> 

                <div data-v-57fbc572="" data-v-57b574e2="" class="form-input">
                <input data-v-57fbc572="" type="text" pattern="^[a-zA-Z0-9.!#$%&amp;’*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+\.([A-Za-z]{2,4})$" id="input-Email" class=""> 
                <label data-v-57fbc572="" for="input-Email" class="m-0">Mobile Number</label>
                </div>


                <div data-v-57fbc572="" data-v-57b574e2="" class="form-input">
                <input data-v-57fbc572="" type="text" pattern="^[a-zA-Z0-9.!#$%&amp;’*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+\.([A-Za-z]{2,4})$" id="input-Email" class=""> 
                <label data-v-57fbc572="" for="input-Email" class="m-0">Email Address</label>
                </div>

                <div data-v-57fbc572="" data-v-57b574e2="" class="form-input">
                <input data-v-57fbc572="" type="text" pattern="^[a-zA-Z0-9.!#$%&amp;’*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+\.([A-Za-z]{2,4})$" id="input-Email" class=""> 
                <label data-v-57fbc572="" for="input-Email" class="m-0">City</label>
                </div> 
                
                
                 <button data-v-57b574e2="" type="button"  class="btn btn-primary btn-secondary btn-block ">Submit</button></div> <div data-v-57b574e2="" class="position-relative"><div data-v-57b574e2="" class="line"></div> 
                
                </div> 
                
                  </div>
                  </div> 
                  <div data-v-d2d8182a="" data-v-6eac0c7d="" id="payment-section-wrap"><div data-v-d2d8182a="" id="payment-section" class="text-center p-4 mt-4">
                </div> <!----></div> <!----></div>
			</div>
		</div>
	</div>
