        ...
        <div class="dlab-bnr-inr overlay-primary" style="background-image:url(images/banner/bnr5.jpg);">
            <div class="container">
                <div class="dlab-bnr-inr-entry">
                    <h1 class="text-white">Repairs and Maintenance</h1>
					<!-- Breadcrumb row -->
					...
					<div class="row">
						<div class="col-lg-8 col-md-7">
							<div class="section-head text-black">
								<h4 class="box-title m-tb0">Repairs and Maintenance<span class="bg-primary"></span></h4>
								<p>Perform an inspections (Inside and outside) and prepare a report and maintenance.Send a complete estimate along with inspection report and snaps so that owner has all required information about maintenance.</p>
								<p>Repair and send the report and snaps after getting the work done.</p>
							</div>
							<div class="section-head text-black">
								<h4 class="box-title m-tb0">Annual Contract<span class="bg-primary"></span></h4>
								<p>This service is very useful when owners wants to get Single Point of contact for all there repair and maintanence work in one. property or multiple property.</p>
								<p>Refer to the subscription section for pricing details.</p>
							</div>
						</div>
